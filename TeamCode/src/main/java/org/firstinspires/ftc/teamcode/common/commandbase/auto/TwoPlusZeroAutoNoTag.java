...
public class TwoPlusZeroAutoNoTag extends SequentialCommandGroup {
    public TwoPlusZeroAutoNoTag(DepositSubsystem depositSubsystem, LiftSubsystem liftSubsystem, Camera camera, SampleMecanumDrive drive, IntakeSubsystem intakeSubsystem){
        addCommands(
