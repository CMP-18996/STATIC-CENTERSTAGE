    ...
    public void run() {
        ...
        for (AprilTagDetection detection : currentDetections) {
            if (detection.metadata != null) {
                ...
                telemetry.addLine(String.format("True x y", detection.ftcPose.y * Math.cos(detection.ftcPose.yaw) + detection.ftcPose.x, detection.ftcPose.y * Math.sin(detection.ftcPose.yaw)));
            } else {
