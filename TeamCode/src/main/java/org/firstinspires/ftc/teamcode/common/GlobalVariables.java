...
public class GlobalVariables {
    ...
    public enum Distance {
        BLUECLOSE(new Pose2d(12, 60, Math.toRadians(-90))),
        BLUEFAR(new Pose2d(-35, 60, Math.toRadians(-90))),
        REDCLOSE(new Pose2d(12, -60, Math.toRadians(90))),
        REDFAR(new Pose2d(-35, -60, Math.toRadians(90)));
