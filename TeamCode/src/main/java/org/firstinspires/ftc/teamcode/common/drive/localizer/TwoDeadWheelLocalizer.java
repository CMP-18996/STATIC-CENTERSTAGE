...
public final class TwoDeadWheelLocalizer implements Localizer {
    public static class Params {
        //left
        public double parYTicks = -11644.462313754837; // y position of the parallel encoder (in tick units)
        public double perpXTicks = -10180.492940532378; // x position of the perpendicular encoder (in tick units)
    }
